...
/**
 * Require `IErrorHandlerService`, `IResponseService` from `@lst97/common_response` which injected by inversify.
 */
export interface IJwtMiddlewareService {
 ...
 */
@injectable()
export class JwtMiddlewareService implements IJwtMiddlewareService {
...
export const JwtMiddlewareServiceInstance = () =>
